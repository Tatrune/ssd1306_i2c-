...
/* Buffer for data */
static char buffer[SSD1306_MAX_SEG];
...
{
    ssd1306_write(module, true, 0x20); // Lệnh Set Memory Addressing Mode
    ssd1306_write(module, true, 0x02); // 0x02 = Page Addressing Mode
}
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("tantrun9920@gmail.com");
